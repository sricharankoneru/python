...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    actual_exchange_rate = exchange_rate + spread_value

    exchanged_value = exchange_money(budget, actual_exchange_rate)
    
    leftover_value = get_leftover_of_bills(exchanged_value, denomination)

    return int(exchanged_value - leftover_value)
